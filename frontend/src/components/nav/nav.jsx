        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              <Link to="/" className="hover:text-amber-200 transition flex items-center">
                <Home className="mr-1 h-4 w-4" />
                Home
              </Link>
              <Link to="/about" className="hover:text-amber-200 transition flex items-center">
                <Info className="mr-1 h-4 w-4" />
                About
              </Link>
              {user && (
                <>
                  <Link to="/news" className="hover:text-amber-200 transition flex items-center">
                    <BarChart2 className="mr-1 h-4 w-4" />
                    News
                  </Link>
                  <Link to="/devices" className="hover:text-amber-200 transition flex items-center">
                    <Smartphone className="mr-1 h-4 w-4" />
                    Devices
                  </Link>
                  <Link to="/issue-requests" className="hover:text-amber-200 transition flex items-center">
                ...
                <div className="relative">
                  ...
                  {userMenuOpen && (
                    <div className="absolute right-0 mt-2 w-64 bg-white text-gray-800 rounded-md shadow-lg py-1 z-10">
                      ...
                      <Link to="/security" className="flex items-center px-4 py-2 hover:bg-gray-100">
            ...
            {isOpen && (
              ...
              >
                <div className="flex flex-col space-y-4 py-4">
                  <Link to="/" className="hover:bg-emerald-700 px-4 py-2 rounded">
                    <Home className="inline-block mr-2 h-4 w-4" />
                    Home
                  </Link>
                  <Link to="/about" className="hover:bg-emerald-700 px-4 py-2 rounded">
                    <Info className="inline-block mr-2 h-4 w-4" />
                    About
                  </Link>
                  {user && (
                    <>
                      <Link to="/dashboard" className="hover:bg-emerald-700 px-4 py-2 rounded">
                        <BarChart2 className="inline-block mr-2 h-4 w-4" />
                        Dashboard
                      </Link>
                      <Link to="/devices" className="hover:bg-emerald-700 px-4 py-2 rounded">
